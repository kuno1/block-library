...
registerBlockType( 'kunoichi/dt', {
	...
	save( { attributes } ) {
		return <RichText.Content tagName="dt" multiline={ false } className='kbl-dl-term' value={ attributes.content } />
	},
} );
...
registerBlockType( 'kunoichi/dd', {
	...
	save( { attributes } ) {
		return <RichText.Content tagName="dd" multiline={ false } className='kbl-dl-description' value={ attributes.content } />
	},
} );
...
registerBlockType( 'kunoichi/definition-list', {
	...
	icon: (
			<SVG viewBox="0 0 20 20">
				<G id="step">
					<Rect x="1.5" y="2.5" width="16.5" height="2" style={ { fill: '#898989', stroke: '#444', strokeMiterlimit: 10 } }/>
					<Rect x="4.8" y="6.5" width="13.2" height="2" style={ { fill: '#fff', stroke: '#444', strokeMiterlimit:10 } } />
					<Rect x="1.5" y="10.5" width="16.5" height="2" style={ { fill: '#898989', stroke: '#444', strokeMiterlimit: 10 } }/>
					<Rect x="4.8" y="14.5" width="13.2" height="2" style={ { fill: '#fff', stroke: '#444', strokeMiterlimit:10 } } />
				</G>
			</SVG>
	),
